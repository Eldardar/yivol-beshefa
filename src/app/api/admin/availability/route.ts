...
import { adminWorkerAvailabilityWindow } from "@/lib/dates";
...
export async function POST(req: Request) {
  ...
  try {
    ...
    await new AdminService(database).setWorkerAvailability(user.id, { userId: body.userId, entries: body.entries }, adminWorkerAvailabilityWindow());
