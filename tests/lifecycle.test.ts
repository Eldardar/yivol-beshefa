...
function setup() {
  ...
  const shift = Number(db.prepare("INSERT INTO shifts(date,slot,season_id,leader_id,notes,created_by) VALUES(?,?,?,?,?,?)").run("2026-08-10", "MORNING", season, p1, "", admin).lastInsertRowid);
